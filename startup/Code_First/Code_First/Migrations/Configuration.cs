namespace Code_First.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Code_First.Classes.Context>
    {
        ...
        protected override void Seed(Code_First.Classes.Context context)
        {
